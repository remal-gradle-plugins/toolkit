...
class MaxTestableVersionTest extends AbstractSupportedVersionExtensionTests {
    ...
    @MaxTestableVersion(module = "module", version = "5.0")
    @ExampleTests
    ...
    @ExtendWith(ModuleVersion6.class)
    @MaxTestableVersion(module = "module", version = "6.0")
    @ExampleTests
    @SuppressWarnings({"java:S5810", "java:S2699", "java:S5790"})
    ...
    @ExtendWith(ModuleVersion6.class)
    @MaxTestableVersion(module = "module", version = "7.0")
    @ExampleTests
    @SuppressWarnings({"java:S5810", "java:S2699", "java:S5790"})
