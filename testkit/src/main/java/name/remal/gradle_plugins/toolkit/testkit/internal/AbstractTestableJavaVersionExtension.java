...
@Internal
abstract class AbstractTestableJavaVersionExtension implements ExecutionCondition {

    @VisibleForTesting
    static final Namespace NAMESPACE = Namespace.create(AbstractTestableJavaVersionExtension.class);
