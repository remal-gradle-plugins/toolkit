...
import static name.remal.gradle_plugins.toolkit.reflection.MembersFinder.getOptionalMethod;
...
public abstract class GroovyXmlUtils {
    ...
    public static String prettyGroovyXmlString(Node node) {
        return prettyGroovyXmlString(node, XmlFormat.DEFAULT_XML_FORMAT);
    }
