...
class CrossCompileVersionComparatorTest {
    ...
    void standardVersionCrossCompileVersionComparator() throws Throwable {
        ...
        assertEquals(DEPENDENCY_GREATER_THAN_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
            "test",
            "2.1.1"
        ));
        assertEquals(DEPENDENCY_GREATER_THAN_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
        ...
        assertEquals(DEPENDENCY_EQUALS_TO_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
            "test",
            "2.1.0"
        ));
        assertEquals(DEPENDENCY_EQUALS_TO_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
        ...
        assertEquals(DEPENDENCY_LESS_THAN_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
            "test",
            "2.0"
        ));
        assertEquals(DEPENDENCY_LESS_THAN_CURRENT, comparator.compareDependencyVersionToCurrentVersion(
